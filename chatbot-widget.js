...
function startConversation() {
    fetch('https://chatbot-for-bassprinting-2-samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
   ...
   // Clear the input field immediately after sending the message
    ...
    fetch('https://chatbot-for-bassprinting-2-samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGAS(message, isUserMessage) {
    var GAS_URL = 'https://script.google.com/macros/s/AKfycbwT7_EoL4gpob2H-TXQtL4WG4TYrP7pkqgI-bR_VaKfIVdWghPYpqc_EGbB3IaL6oza/exec';
